...
| **`groups`** | Gastos compartidos estilo Splitwise: grupos con otros usuarios reales, división en partes iguales, saldos y simplificación de deudas. Un gasto se puede corregir después (typo o monto mal tipeado) — solo quien lo pagó o el owner del grupo, recalculando los shares. Un grupo se borra por consenso: un miembro lo propone y el resto aprueba; con la aprobación de todos los miembros aceptados se borra en cascada (bloqueado si quedan saldos ≠ 0). |
